...
public class MoneyMenus {
    public static final MenuType<CompressorMenu> COMPRESSOR_MENU = Registry.register(BuiltInRegistries.MENU,
            Identifier.fromNamespaceAndPath(MoneyTalks.MOD_ID, "doubloon_compressor"), new MenuType<>((syncId, inventory) -> new CompressorMenu(syncId, inventory, new SimpleContainer(3), new SimpleContainerData(2)), FeatureFlags.DEFAULT_FLAGS));
