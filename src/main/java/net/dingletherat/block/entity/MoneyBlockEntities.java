...
public class MoneyBlockEntities {
    ...
    public static final BlockEntityType<DoubloonEntity> DOUBLOON_ENTITY =
            Registry.register(BuiltInRegistries.BLOCK_ENTITY_TYPE, Identifier.fromNamespaceAndPath(MoneyTalks.MOD_ID, "doubloon_entity"),
                    FabricBlockEntityTypeBuilder.<DoubloonEntity>create(DoubloonEntity::new, (Block) MoneyBlocks.DOUBLOON).build());
